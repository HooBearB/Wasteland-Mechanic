...
\ \  \ \ \|\  \ \ \ \____|  \ \ \___|  \ \  \_\  \ \ \  \__\ \ \ \  \__|\  \ \|__|\  \__| \ \ \___|
 \ \  \ \_\ \  \ \ \  ____\  \ \ \      \ \   __  \ \ \   __  \ \ \  \ \ \  \    \ \  \    \ \ \
  \ \  \|_|\ \  \ \ \ \___|_  \ \ \_____ \ \  \ \  \ \ \  \|\  \ \ \  \ \ \  \   _\_\  \___ \ \ \_____
   \ \__\   \ \__\ \ \______\  \ \______\ \ \  \ \  \ \ \__\ \__\ \ \__\ \ \__\ |\_________\ \ \______\
...
def loadProgress():
    ...
    print("run unwanted programs on your computer. I'll figure out how")
    print("to sign data with HMAC. Save file authentication may be")
    print("introduced in v0.3.\n")
    plrinput = input("\n>>> ")
    plrinput = str(plrinput)
    save = plrinput + ".p"
